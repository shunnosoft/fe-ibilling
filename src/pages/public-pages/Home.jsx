      ...
      <div className="landingWrapper">
        <div className="container-fluide landingContainer">
          ...
          <div className="textBox2">
            ...
            <br />
            <h3>ওয়ানবিলিং সফটওয়্যার এ রয়েছে উপযোগী কিছু আকর্ষণীয় ফিচার।</h3>
            ...
            <br />
            <h3>ওয়ানবিলিং এর সুবিধাসমূহঃ</h3>
            <ul className="bulletul2 mb-5">
              <li>
                ওয়ানবিলিংতে আপনি পাবেন এডমিন, ম্যানেজার, রিসেলার, কালেক্টর,
                লাইনম্যান এবং কাস্টমার প্যনেল।
              </li>
              <li>
                এডমিন এবং ম্যানেজার ওয়েবসাইটের মাধ্যমে ওয়ানবিলিং সফটওয়্যার
                ব্যবহার করতে পারবে।
              </li>
              <li>
                রিসেলার, কালেক্টর এবং লাইনম্যান ওয়েবসাইট এবং মোবাইল এপের মাধ্যমে
                ওয়ানবিলিং সফটওয়্যার ব্যবহার করতে পারবে।
              </li>
              <li>
