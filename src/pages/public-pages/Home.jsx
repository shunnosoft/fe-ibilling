    ...
    <div>
      <div className="textBox2">
        <p className="intro1">
          ...
          হিসেবে ইন্টারনেট এর ভূমিকা অপরিসীম। সঠিক চ্যানেল ও ডিস্ট্রিবিউশন এর
          মাধ্যমে ঘরে ঘরে ইন্টারনেট পৌঁছে দিতে সার্ভিস প্রোভাইডারদের বিভিন্ন
          সমস্যা সমাধানের লক্ষ্যে <i>শূন্য আইটি</i> নিয়ে এসেছে সহজে ব্যবহারযোগ্য
          এবং মাতৃভাষা বাংলায় দেশের প্রথম আইএসপি বিলিং সফটওয়্যার{" "}
          <strong>
            <i>নেটফি </i>
          </strong>
          । <br /> <br />
          সম্পূর্ন অনলাইন এই সফটওয়্যারটি, সার্ভিস এবং গ্রাহক সংখ্যার উপর ভিত্তি
          করে বিভিন্ন প্যকেজ আকারে ইন্টারনেট প্রোভাইডারদের হাতে পৌঁছে দেওয়া হয়।
          আমাদের দক্ষ ডেভেলপার ও সাপোর্ট টিম সর্বদা সর্বোচ্চ গ্রাহক সেবায়
          নিয়োজিত আছেন।
        </p>
        <br />
        ...
        <ul className="bulletul2 mb-5">
          <li>
            নেটফিতে আপনি পাবেন এডমিন, ম্যানেজার, রিসেলার, কালেক্টর, লাইনম্যান
            এবং কাস্টমার প্যনেল।
          </li>
          <li>
            এডমিন এবং ম্যানেজার ওয়েবসাইটের মাধ্যমে নেটফি সফটওয়্যার ব্যবহার করতে
            পারবে।
          </li>
          <li>
          ...
          <li>
            আপনার গ্রাহকগণ মোবাইল এপের মধ্যমে তাদের সকল তথ্য দেখতে পারবেন এবং
            পেমেন্ট গেটওয়ের মাধ্যমে মাসিক বিল পরিশোধ করতে পারবে।
          </li>
          <li>
            লাইনম্যান মোবাইল এপের মাধ্যমে নতুন সংযোগ/আইডি তৈরি করতে পারবে। নতুন
            সংযোগ দেয়ার সময় আইডি তৈরির ঝামেলা পোহাতে হবেনা।{" "}
          </li>
          <li>
            বিল কালেক্টর ওয়েব অথবা মোবাইল এপের মাধ্যমে গ্রাহকের বিল আদায় করতে
            পারবে।
          </li>
          <li>
            গ্রাহকের বিলিং ডেট অতিক্রম করলে এবং গ্রাহক বিল প্রদান না করলে
            গ্রাহকের সংযোগ অটোমেটিক বন্ধ হয়ে যাবে এবং বিল প্রদানের পর গ্রাহকের
            সংযোগ অটোমেটিক চালু হয়ে যাবে।
          </li>
