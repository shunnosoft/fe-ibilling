...
import { getActiveCustomer } from "../../features/resellerCustomerAdminApi";
...
import StaticCustomerDetails from "../staticCustomer/staticCustomerCrud/CustomerDetails";
...
const Active = ({
  ...
  useEffect(() => {
    status === "active" &&
      getActiveCustomer(dispatch, resellerId, year, month, setIsLoading);
  }, [month, status, year]);
        ...
        <ModalHeader closeButton>
          <ModalTitle>
            <div className="d-flex align-items-center">
              <h5 className="text-secondary">{t("activeCustomer")}</h5>
